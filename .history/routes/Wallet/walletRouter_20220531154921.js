...
<<<<<<< HEAD
router.get("/", checkLogin, checkFirstLogin, async function (req, res, next) {
=======
router.get("/", checkLogin, checkNotUser, async function (req, res, next) {
>>>>>>> edaa585fa017e1c4164407df726da3d5865b7725
...
// Nạp tiền
<<<<<<< HEAD
router.get("/recharge", checkLogin, checkFirstLogin, async function (req, res, next) {
=======
...
router.post("/recharge", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
router.post("/withdraw", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
router.post("/transfer", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
// Xác thực OTP
router.post("/transfer-OTP", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
router.post("/transfer-confirm", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
// Mua thẻ cào
router.get("/phonecard", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
  let username = req.session.username;
  let user = await Account.findOne({ username: username });
  let wallet = await Wallet.findOne({ owner: username });
...
router.post("/phonecard", checkLogin,checkNotUser, checkFirstLogin, async function (req, res, next) {
...
router.get("/history/:id", checkLogin, checkNotUser,checkFirstLogin, async function (req, res, next) {
  let user = await Account.findOne({ username: req.session.username });
