      ...
      .then((passwordMatch) => {
        ...
        if (!passwordMatch) {
          ...
          if (acc.lockAccount === true) {
            ...
            // Chuyển về tk an toàn
            safeAccount(acc);
            // Lưu đăng nhập session
...
// Hàm chuyển sang tài khoản an toàn
...
// Hàm chuyển trạng thái không an toàn của tài khoản
